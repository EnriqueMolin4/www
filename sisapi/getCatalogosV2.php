...
$sqlAplicativo = "SELECT id,nombre FROM tipo_aplicativo WHERE estatus=1 and clave_elavon != 0 ";
...
$tpvComercio = $Api->select($sqlTpvComercio, array($odt));
...
echo json_encode(['status' => 1,'aplicativo' => $aplicativo, 'evidencias' => $evidencias,'version' => $version,'kit' => $kit, 'tpv' => $tpv,'sims'=> $sims, 'tpvComercio' => $tpvComercio,'causas'=> $causas ]);
