...
<body>
    <div class="page-wrapper ice-theme sidebar-bg bg1 toggled">
        ...
        <main class="page-content">
            ...
            <div class="container-fluid p-4 panel-white"><br>
                    ...
                    <div class="row">
                        <div class="col p-4">
                            <div class="table-responsive">  
                                    ...
                                    <table id="tblCP" class="table table-striped table-bordered table-responsive">
                                        <thead>
                                            <tr>
                                                <th width="800px">CP</th>
                                                <th width="800px">ACCION</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                ...
                $(document).on('click','.deleteCP', function() {
                    ...
                    $.ajax({
                        ...
                        success: function(data, textStatus, jqXHR){
                            tblCP.ajax.reload();
                            $.toaster({
                                message: 'Se borró con éxito el CP' ,
                                title: 'Aviso',
                                priority : 'success'
                            });  
