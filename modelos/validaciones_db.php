...
class Validaciones implements IConnections {
	...
	function getEstados() {
        ...
        try {
            ...
            self::$logger->error ("File: validaciones_db.php;	Method Name: getEstados();	Functionality: Get Products price From PriceLists;	Log:" . $e->getMessage () );
        }
    }
    ...
    function getEvento($id) {
        ...
        try {
            ...
            self::$logger->error ("File: validaciones_db.php;	Method Name: getEvento();	Functionality: Get Products price From PriceLists;	Log:" . $e->getMessage () );
        }
	}
